...
Auth/RBAC: ASP.NET Core Identity (cookie auth) + role Menedżer/Operator + autoryzacja widoków/akcji (np. [Authorize(Roles="Manager")] dla Panelu i “Wyślij do klienta”).
